...
//		}
		...
		// ^ this arrlist serves no purpose
		// ArrayList<Integer> expenses = new ArrayList<Integer>();
		// changed to static class variable since it resets its contents every time
		// optionsSelctions() is called

		System.out.println("\nEnter your choice:\t");
		Scanner sc = new Scanner(System.in);
		int options = sc.nextInt();
		// deleted unnecessary for loop
		switch (options) {
		case 1:
	...
	private static void searchExpenses(ArrayList<Integer> arrayList) {
		...
		for (int i : arrayList) {
			if (i == target) {
				System.out.println("Target : " + i + " found");
				return;
			}
		}
